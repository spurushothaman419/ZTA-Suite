...
export const ztmmPillars: ZTMMPillar[] = [
  ...
  },
  {
    ...
    description: 'Cross-cutting capability for Zero Trust governance, risk management, and compliance',
    icon: 'Scale',
    functions: [
      {
        id: 'gov-strategy',
        name: 'Zero Trust Strategy & Planning',
        description: 'Strategic planning and roadmap for Zero Trust implementation',
        questions: [
          {
            id: 'gov-1',
            question: 'Does your organization have a documented Zero Trust strategy and implementation roadmap?',
            guidance: 'Consider executive sponsorship, strategic alignment, and phased implementation plans',
            traditionalIndicator: 'No formal Zero Trust strategy; ad-hoc security improvements',
            initialIndicator: 'Basic Zero Trust strategy documented; some executive awareness',
            advancedIndicator: 'Comprehensive ZT strategy with executive sponsorship; phased roadmap with milestones',
            optimalIndicator: 'Mature ZT program with continuous improvement; fully integrated into business strategy',
          },
          {
            id: 'gov-2',
            question: 'How is Zero Trust governance structured within your organization?',
            guidance: 'Evaluate governance bodies, roles, responsibilities, and decision-making processes',
            traditionalIndicator: 'No dedicated ZT governance; security decisions made in silos',
            initialIndicator: 'Some ZT governance structure; periodic steering committee meetings',
            advancedIndicator: 'Formal ZT governance board; clear roles and responsibilities; regular reviews',
            optimalIndicator: 'Enterprise-wide ZT governance; integrated with IT and business governance; continuous oversight',
          },
          {
            id: 'gov-3',
            question: 'How does your organization measure Zero Trust maturity and progress?',
            guidance: 'Consider metrics, KPIs, assessments, and reporting mechanisms',
            traditionalIndicator: 'No formal ZT metrics or assessments',
            initialIndicator: 'Basic metrics tracked; periodic self-assessments',
            advancedIndicator: 'Comprehensive ZT metrics dashboard; regular maturity assessments; trend analysis',
            optimalIndicator: 'Real-time ZT metrics; continuous maturity monitoring; predictive analytics',
          },
        ],
      },
      {
        ...
        description: 'Zero Trust policies, standards, and guidelines',
        questions: [
          {
            id: 'pol-gov-1',
            question: 'How comprehensive are your Zero Trust policies and standards?',
            guidance: 'Evaluate policy coverage, alignment with frameworks, and enforcement mechanisms',
            traditionalIndicator: 'Limited security policies; not aligned with Zero Trust principles',
            initialIndicator: 'Some ZT-aligned policies; basic standards documented',
            advancedIndicator: 'Comprehensive ZT policy framework; aligned with CISA ZTMM and NIST 800-207',
            optimalIndicator: 'Dynamic policy framework; continuous policy optimization; automated enforcement',
          },
          {
            id: 'pol-gov-2',
            question: 'How are Zero Trust policies communicated and enforced across the organization?',
            guidance: 'Consider policy distribution, training, awareness, and compliance monitoring',
            traditionalIndicator: 'Policies not widely communicated; limited enforcement',
            initialIndicator: 'Policies distributed to key stakeholders; some training provided',
            advancedIndicator: 'Organization-wide policy awareness; regular training; compliance monitoring',
            optimalIndicator: 'Continuous policy communication; automated compliance checks; real-time enforcement',
          },
        ],
      },
      {
        ...
        description: 'Zero Trust risk assessment and management processes',
        questions: [
          {
            id: 'risk-gov-1',
            question: 'How does your organization assess and manage Zero Trust-related risks?',
            guidance: 'Consider risk assessment methodologies, risk registers, and mitigation strategies',
            traditionalIndicator: 'Ad-hoc risk assessments; no formal ZT risk management',
            initialIndicator: 'Periodic risk assessments; basic risk register maintained',
            advancedIndicator: 'Continuous risk assessment; comprehensive risk management program; prioritized mitigation',
            optimalIndicator: 'Real-time risk monitoring; AI-driven risk analysis; automated risk response',
          },
          {
            id: 'risk-gov-2',
            question: 'How is risk appetite defined and communicated for Zero Trust initiatives?',
            guidance: 'Evaluate risk tolerance levels, risk acceptance criteria, and stakeholder alignment',
            traditionalIndicator: 'No defined risk appetite; inconsistent risk decisions',
            initialIndicator: 'Basic risk appetite defined; some stakeholder awareness',
            advancedIndicator: 'Clear risk appetite framework; aligned with business objectives; regular reviews',
            optimalIndicator: 'Dynamic risk appetite; real-time adjustment based on threat landscape; full alignment',
          },
        ],
      },
      {
        ...
        description: 'Compliance with regulations, standards, and mandates',
        questions: [
          {
            id: 'comp-gov-1',
            question: 'How does your Zero Trust implementation address regulatory compliance requirements?',
            guidance: 'Consider FISMA, FedRAMP, HIPAA, PCI-DSS, and other applicable regulations',
            traditionalIndicator: 'Compliance addressed separately from ZT; manual compliance processes',
            initialIndicator: 'Some ZT controls mapped to compliance requirements; periodic audits',
            advancedIndicator: 'Comprehensive compliance mapping; ZT controls support multiple frameworks; continuous monitoring',
            optimalIndicator: 'Automated compliance verification; real-time compliance dashboards; proactive compliance',
          },
          {
            id: 'comp-gov-2',
            question: 'How does your organization track and report on Zero Trust compliance status?',
            guidance: 'Evaluate compliance tracking tools, reporting mechanisms, and audit readiness',
            traditionalIndicator: 'Manual compliance tracking; limited reporting capabilities',
            initialIndicator: 'Basic compliance tracking; periodic reports to leadership',
            advancedIndicator: 'Automated compliance tracking; comprehensive dashboards; regular executive reporting',
            optimalIndicator: 'Real-time compliance monitoring; predictive compliance analytics; continuous audit readiness',
          },
          {
            id: 'comp-gov-3',
            question: 'How prepared is your organization for Zero Trust-related audits and assessments?',
            guidance: 'Consider evidence collection, documentation, and audit response processes',
            traditionalIndicator: 'Limited audit preparation; manual evidence collection',
            initialIndicator: 'Some audit preparation processes; basic documentation maintained',
            advancedIndicator: 'Comprehensive audit readiness; automated evidence collection; well-documented controls',
            optimalIndicator: 'Continuous audit readiness; real-time evidence availability; automated audit support',
          },
        ],
      },
      {
        ...
        description: 'Zero Trust training, awareness, and culture programs',
        questions: [
          {
            id: 'train-1',
            question: 'How does your organization provide Zero Trust training and awareness?',
            guidance: 'Consider training programs, awareness campaigns, and role-based education',
            traditionalIndicator: 'No ZT-specific training; general security awareness only',
            initialIndicator: 'Basic ZT awareness training; some role-based education',
            advancedIndicator: 'Comprehensive ZT training program; role-specific curricula; regular updates',
            optimalIndicator: 'Continuous ZT education; adaptive learning; embedded security culture',
          },
          {
            id: 'train-2',
            question: 'How is Zero Trust culture promoted across the organization?',
            guidance: 'Evaluate leadership commitment, cultural initiatives, and behavioral changes',
            traditionalIndicator: 'No ZT culture initiatives; security seen as IT responsibility',
            initialIndicator: 'Some leadership support; basic cultural awareness',
            advancedIndicator: 'Strong leadership commitment; security champions program; cultural transformation',
            optimalIndicator: 'Security-first culture; ZT principles embedded in all operations; continuous reinforcement',
          },
        ],
      },
      {
        ...
        description: 'Zero Trust requirements for vendors and supply chain',
        questions: [
          {
            id: 'vendor-1',
            question: 'How does your organization apply Zero Trust principles to vendor and third-party access?',
            guidance: 'Consider vendor risk assessments, access controls, and monitoring',
            traditionalIndicator: 'Vendors have broad access; limited oversight',
            initialIndicator: 'Basic vendor access controls; periodic risk assessments',
            advancedIndicator: 'Strict vendor access policies; continuous monitoring; ZT requirements in contracts',
            optimalIndicator: 'Zero standing vendor access; real-time vendor risk monitoring; automated access governance',
          },
          {
            id: 'vendor-2',
            question: 'How are Zero Trust requirements incorporated into procurement and supply chain processes?',
            guidance: 'Evaluate procurement criteria, supply chain security, and vendor compliance',
            traditionalIndicator: 'No ZT requirements in procurement; limited supply chain visibility',
            initialIndicator: 'Basic security requirements in contracts; some supply chain awareness',
            advancedIndicator: 'ZT requirements in all procurements; supply chain risk management; vendor compliance tracking',
            optimalIndicator: 'Comprehensive supply chain ZT program; real-time vendor compliance; automated risk assessment',
          },
        ],
      },
      {
        ...
        description: 'Zero Trust incident response and business continuity',
        questions: [
          {
            id: 'ir-1',
            question: 'How does your incident response plan incorporate Zero Trust principles?',
            guidance: 'Consider detection, containment, eradication, and recovery processes',
            traditionalIndicator: 'Traditional IR plan; not aligned with ZT architecture',
            initialIndicator: 'IR plan updated for some ZT considerations; basic integration',
            advancedIndicator: 'ZT-aligned IR plan; automated containment; micro-segmentation for isolation',
            optimalIndicator: 'Fully ZT-integrated IR; autonomous response; predictive threat prevention',
          },
          {
            id: 'ir-2',
            question: 'How does your organization ensure business continuity within a Zero Trust architecture?',
            guidance: 'Evaluate resilience, recovery capabilities, and continuity planning',
            traditionalIndicator: 'Traditional BCP; not considering ZT architecture',
            initialIndicator: 'BCP updated for ZT considerations; basic resilience planning',
            advancedIndicator: 'ZT-aligned BCP; automated failover; comprehensive resilience testing',
            optimalIndicator: 'Self-healing ZT architecture; real-time recovery; continuous resilience optimization',
          },
        ],
      },
    ],
